...
class CSCWrapper(SOAPHandlerBase):
    ...
    TEMPLATES = {
        'ApproveOrder': 'ApproveOrder.xml',
        'AvailableSearches': 'AvailableSearches.xml',
        'CreateFiling': 'CreateFiling.xml',
        'ContinueFiling': 'ContinueFiling.xml',
        'GetAttachment': 'GetAttachment.xml',
        'GetChangedOrders': 'GetChangedOrders.xml',
        'GetDetailResults': 'GetDetailResults.xml',
        'GetDocuments': 'GetDocuments.xml',
        'GetJurisdictions': 'GetJurisdictions.xml',
        'GetOrderInformation': 'GetOrderInformation.xml',
        'GetReport': 'GetReport.xml',
        'GetSummaryResults': 'GetSummaryResults.xml',
        'SetSelectedDetailResults': 'SetSelectedDetailResults.xml',
        'SetSelectedSummaryResults': 'SetSelectedSummaryResults.xml',
        'SubmitOfflineSearch': 'SubmitOfflineSearch.xml',
        'SubmitOnlineSearch': 'SubmitOnlineSearch.xml',
        'TerminateFiling': 'TerminateFiling.xml',
        'UpdateFiling': 'UpdateFiling.xml',
        'UploadAttachment': 'UploadAttachment.xml',
        'ValidateFiling': 'ValidateFiling.xml',
    }
